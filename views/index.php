                ...
                <div class="card-body">
                    <div
                        ...
                        <?php foreach ($featuredFilms as $film): ?>
                            <div class="col">
                                <div class="card h-100 bg-dark text-light border-secondary shadow-lg rounded" onclick="window.location.href='./index.php?element=pages&action=Card&id=<?= urlencode($film['media_id']); ?>'">
