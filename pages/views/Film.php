                        ...
                        <?php foreach ($films as $film): ?>
                            <div class="col">
                                <div class="card h-100 bg-dark text-light border-secondary shadow-lg rounded">
                                    ...
                                    <img src="<?= !empty($film['image_url']) ? $film['image_url'] : 'https://m.media-amazon.com/images/M/MV5BYzZlMjE5ZTgtNDU4Yi00NWE0LWIzN2UtZDI5OTc3ZjRiYmYyXkEyXkFqcGc@._V1_SX300.jpg' ?>" 
                                        class="card-img-top rounded fixed-size-image" 
                                        alt="Film poster">
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <span class="badge bg-warning text-dark">★ <?= htmlspecialchars($film['averageRating'] ?? 'N/A') ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
